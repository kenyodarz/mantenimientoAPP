...
@NgModule({
  declarations: [ResumenComponent, HomeComponent, EquipoComponent, VerEquipoComponent, InstructivoComponent, RegistroComponent, EventoComponent, ProgramacionComponent],
  imports: [
    CommonModule,
